...
class CombatSimulator extends EventTarget {
    ...
    async simulate(simulationTimeLimit) {
        ...
        for (let i = 0; i < this.players.length; i++) {
            ...
            // Close an active OOM interval at the simulation boundary. Without
            // this, a player who is out of mana when time expires reports zero
            // time for its final (and often longest) OOM segment.
            this.simResult.addRanOutOfManaCount(this.players[i], false, this.simulationTime);
        }
